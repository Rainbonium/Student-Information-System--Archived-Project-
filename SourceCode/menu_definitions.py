...
delete_menu = Menu('delete', 'Please indicate what you want to delete from:', [
    ...
    Option("Section with Student", "delete_student_section(sess)"),
    Option("Student in Section", "delete_section_student(sess)"),
    Option("Exit", "pass")
])
...
list_menu = Menu('list', 'Please indicate what you want to list:', [
    ...
    Option("Course Sections", "list_course(sess)"),
    Option("Student to Major", "list_student_major(sess)"),
    Option("Major to Student", "list_major_student(sess)"),
    Option("Sections with Student", "list_student_section(sess)"),
    Option("Students in Section", "list_section_student(sess)"),
    Option("Exit", "pass")
])
