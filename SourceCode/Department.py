...
if introspection_type == START_OVER or introspection_type == REUSE_NO_INTROSPECTION:            # Define the entity from scratch
    class Department(Base):
        ...
        __table_args__ = (UniqueConstraint("name", name="departments_pk"),
    ...
    class Department(Base):
        ...
        office: Mapped[str] = column_property(__table__.c.office)
...
setattr(Department, 'add_course', add_course)
setattr(Department, 'remove_course', remove_course)
setattr(Department, 'get_courses', get_courses)
setattr(Department, '__str__', __str__)
